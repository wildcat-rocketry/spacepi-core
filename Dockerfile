...
RUN apt-get update && apt-get upgrade -y && \
    apt-get install -y autoconf-archive git libgps-dev build-essential mosquitto debootstrap qemu-user-static dosfstools kpartx sudo libboost-all-dev libprotobuf-dev default-jdk libssl-dev protobuf-compiler libi2c-dev libgit2-dev libblkid-dev device-tree-compiler && \
