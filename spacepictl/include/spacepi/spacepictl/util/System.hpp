#ifndef SPACEPI_TARGETLIB_LINUX_SPACEPICTL_UTIL_SYSTEM_HPP
#define SPACEPI_TARGETLIB_LINUX_SPACEPICTL_UTIL_SYSTEM_HPP
    ...
    namespace spacepictl {
        namespace util {
            class System : private spacepi::log::AutoLog<decltype("spacepictl:system"_autolog)> {
                public:
                    System(spacepi::spacepictl::util::FSTransaction &fs, const spacepi::package::Options &options, const std::unordered_map<std::string, spacepi::package::Module> &modules);
